<template>
  <section id="trabalhos" class="py-24 md:py-32 px-6 relative">
    <div
      class="absolute inset-0 bg-gradient-to-b from-transparent via-white/[0.01] to-transparent pointer-events-none"
    ></div>

    <div class="max-w-6xl mx-auto relative z-10">
      <div class="text-center mb-16 portfolio-title">
        <p
          class="text-sm font-semibold text-zpurple uppercase tracking-widest mb-4"
        >
          Portfólio
        </p>
        ...
        <p class="text-gray-400 max-w-lg mx-auto">
          Projetos que entregam valor real.
        </p>
      </div>
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <component
            ...
            :class="
              project.type === 'Sistemas' ? 'cursor-default' : 'cursor-pointer'
            "
            ...
            <div class="glass-card p-6 h-full flex flex-col preserve-3d group">
              ...
              <div class="flex-1 flex flex-col">
                <h4
                  ...
                  :class="
                    project.type !== 'Sistemas' ? 'group-hover:text-white' : ''
                  "
                >
                  {{ project.title }}
                </h4>
                ...
                <div class="mt-6 flex items-center justify-between">
                  <div class="flex gap-2">
                    <span
                      v-if="project.type === 'Sistemas'"
                      class="text-[10px] font-bold uppercase tracking-wider text-zpurple/60 border border-zpurple/20 px-2 py-1 rounded"
                    >
                      Sistema Privado
                    </span>
                  </div>
                  <div
                    v-if="project.type !== 'Sistemas'"
                    class="w-8 h-8 rounded-full glass flex items-center justify-center text-white/50 group-hover:text-white group-hover:bg-white/10 transition-all duration-300"
                  >
                    <svg
                      class="w-4 h-4"
                      fill="none"
...
const projects = [
  {
    ...
    type: "Sites",
    description:
      "Site sofisticado para rede de barbearias com agendamento online, apresentação de unidades e portfólio de serviços com design atemporal.",
  ...
  },
  {
    ...
    type: "Sites",
    description:
      "Experiência premium para o mercado imobiliário de Porto Belo, com galeria imersiva e navegação sofisticada.",
  ...
  },
  {
    ...
    type: "Sites",
    description:
      "Plataforma de alto padrão para consultoria imobiliária, focada em investimentos de luxo e pré-lançamentos exclusivos.",
...

  {
    ...
    type: "Sites",
    description:
      "Guia comercial digital que conecta moradores aos comércios e serviços da cidade, com busca por categoria, atendimento via WhatsApp e um bot inteligente.",
  ...
  },
  {
    ...
    type: "Sites",
    description:
      "Seu app de nutrição com inteligência artificial. Analise refeições por foto, acompanhe metas de água, peso e calorias de forma simples e leve.",
  ...
  },
  {
    ...
    type: "Sites",
    description:
      "Plataforma mobile-first para locação de festas com catálogo interativo, orçamentos rápidos e gestão de pedidos via painel administrativo.",
  ...
  },
  {
    ...
    type: "Sites",
    description:
      "Gestão completa de planetários itinerantes com multi-tenant, venda de ingressos online, controle financeiro e sorteios interativos em tempo real.",
  ...
  },
  {
    ...
    type: "Sistemas",
    description:
      "Plataforma completa para barbearias com controle de créditos, agendamento online e automação de marketing via WhatsApp API.",
  ...
  },
  {
    ...
    type: "Sistemas",
    description:
      "Gestão completa de RH multi-escolas com admissão digital, SmartMail com IA e auditoria de processos automatizada.",
  ...
  },
  {
    ...
    type: "Sistemas",
    description:
      "Gestão completa para pizzarias com PDV, KDS, app do garçom, delivery integrado e controle de estoque em tempo real.",
  ...
  },
  {
    ...
    type: "Sistemas",
    description:
      "Central de atendimento multi-agente para WhatsApp com distribuição de chats, métricas em tempo real e controle de acesso granular.",
  ...
  },
  {
    ...
    type: "Sistemas",
    description:
      "Sistema completo para vendas e atendimento com bot de WhatsApp IA, CRM integrado e gestão de assinaturas recorrentes.",
